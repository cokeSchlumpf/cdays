...
api.get('/show-chat-message', (req, res) => {
  ...
  store.dispatch({
    type: 'COMPONENTS_CHAT_USER_MESSAGE_CHANGE',
    broadcast: true,
    payload: {
      message: 'Hallo Andre, wir haben deine Antwort erhalten, Vielen Dank. Du hast Elektrogeräte aufgenommen – hier würden wir dir einen Wechsel in unsere Hausrat Comfort empfehlen. Hast du dazu noch eine Frage, bei der ich helfen kann?'
    }
  });
